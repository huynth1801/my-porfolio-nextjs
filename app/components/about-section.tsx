...
export default function AboutSection() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/10 via-purple-500/10 to-pink-500/10 blur-3xl opacity-40 pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          {/* Glow behind images */}
          <div className="absolute -inset-8 bg-gradient-to-tr from-cyan-500/20 via-purple-500/10 to-pink-500/20 blur-3xl rounded-full" />
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-cyan-500 to-pink-500 text-white text-xs font-semibold uppercase tracking-widest shadow-md">
  ...
  return (
    ...
    >
      <div className="relative group rounded-xl bg-[#141418]/70 backdrop-blur-sm border border-[#1f1f23] hover:border-transparent transition-all duration-300 overflow-hidden shadow-[0_0_25px_-8px_rgba(0,255,255,0.15)]">
        ...
        <div
          className={`absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gradient-to-tr ${gradient} blur-xl`}
        />
